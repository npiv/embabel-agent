...
WARNING: (jasper notes) What will we do with all of the folks who have anaemic domain objects, and perform orchestration on them via services. Can we bring in services as tools as well?
